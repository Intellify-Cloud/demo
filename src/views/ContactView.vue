      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-12 md:mb-16 text-center">
          ...
          <h1 class="text-4xl md:text-5xl font-bold tracking-tight mt-2">
            {{ site.contact.title_prefix }}
            <span class="gradient-text">{{ site.contact.title_highlight }}</span>
          </h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-8">
          <aside
            class="rounded-2xl border border-stroke bg-surface-muted p-8 flex flex-col justify-between"
          >
            <div>
              <p class="text-sm font-extrabold uppercase tracking-widest text-fg-muted">
                Start Here
              </p>
              ...
              <p class="mt-4 leading-relaxed text-fg-muted">
                Share what you do, what you need your website to achieve, and how soon you want to
                go live. We will help you choose a monthly plan that fits.
              </p>
            </div>

            <div class="mt-8 space-y-4">
              <a
                class="flex flex-col gap-1 rounded-xl border border-stroke px-4 py-3 bg-surface-soft"
          ...
          <form
            class="rounded-2xl border border-stroke p-8 space-y-6 bg-surface-muted"
          ...
          >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div class="field">
                <label for="name" class="block text-sm font-semibold mb-1"
                  >{{ site.contact.fields.name }} *</label
                >
                <input
                  id="name"
                  v-model="form.name"
            ...
            <p class="text-sm">
              No upfront build cost. Domain, hosting, code management, and ongoing support are
              handled through your monthly subscription.
            </p>
          </form>
        </div>
      </div>
...
<script setup lang="ts">
  ...
  useHead({
    ...
    meta: [
      {
        name: 'description',
        content: 'Contact Intellify to start your managed portfolio website.',
      },
